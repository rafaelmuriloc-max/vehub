...
- `src/pages/Personnel.tsx`: estado `syncingVacation`, botão, carga de `employee_vacation_periods`, linha expansível do funcionário (linha extra com `colSpan` e tabela interna dos períodos), card e dialog de férias.
