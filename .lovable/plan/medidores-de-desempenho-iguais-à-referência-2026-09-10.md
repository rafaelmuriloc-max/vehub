...
- Aumentar o tamanho da fonte do título "Desempenho geral da operação" no card principal.
...
- Aumentar classes de texto do título do card principal (ex.: `text-lg`/`text-xl` e `font-bold`).
