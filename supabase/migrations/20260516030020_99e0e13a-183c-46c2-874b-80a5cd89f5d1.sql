...
SELECT cron.unschedule('gmail-sync-every-2min') WHERE EXISTS (SELECT 1 FROM cron.job WHERE jobname='gmail-sync-every-2min');

SELECT cron.schedule(
  'gmail-sync-every-2min',
  '*/2 * * * *',
  $$
  SELECT net.http_post(
    url:='https://ismgjjvarzzfsbdpthot.supabase.co/functions/v1/gmail-sync',
