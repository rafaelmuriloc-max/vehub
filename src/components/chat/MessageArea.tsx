...
export function MessageArea({ conversationName, messages, currentUserId, onSend, onSendMedia, onSendLocation, onSendContact, onPickFromObligation, isGroup, avatarUrl, currentUserName, companyNames, isClosed, onCloseTicket, onReopenTicket, onTransferTicket, whatsappPhone, onBack, isAdmin, onEditMessage, onDeleteMessageForMe, onDeleteMessageForAll, onDeleteConversation, onRenameConversation, onRegisterContact, conversationId, onRequestTask, rightPanel }: MessageAreaProps) {
  ...
  // Visual viewport: detect on-screen keyboard so the input sticks above it
  const { height: vvHeight, offsetTop: vvOffset } = useVisualViewport();
  const keyboardInset = typeof window !== 'undefined'
    ? Math.max(0, window.innerHeight - vvHeight - vvOffset)
    : 0;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'200\' height=\'200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cdefs%3E%3Cpattern id=\'p\' width=\'40\' height=\'40\' patternUnits=\'userSpaceOnUse\'%3E%3Ccircle cx=\'20\' cy=\'20\' r=\'1\' fill=\'%23ccc\' opacity=\'0.15\'/%3E%3C/pattern%3E%3C/defs%3E%3Crect fill=\'%23ECE5DD\' width=\'200\' height=\'200\'/%3E%3Crect fill=\'url(%23p)\' width=\'200\' height=\'200\'/%3E%3C/svg%3E")', backgroundColor: '#ECE5DD', paddingBottom: keyboardInset > 0 ? keyboardInset : undefined }}
      >
      ...
      {/* Input */}
      <div className="shrink-0" style={{ transform: keyboardInset > 0 ? `translateY(-${keyboardInset}px)` : undefined }}>
      {isClosed ? (
