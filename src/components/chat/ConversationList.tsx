        ...
        {loading ? (
          ...
          filtered.map(conv => (
            <button
              ...
              className={`w-full gap-3 px-2 py-2.5 md:px-3 md:py-3 transition-colors border-b border-border/30 flex items-start justify-start shadow-sm border-solid bg-slate-50 opacity-100 rounded-sm ${
