        ...
        {loading ? (
          ...
          filtered.map(conv => (
            <button
              ...
              className={`w-full gap-3 px-2 py-2.5 md:px-3 md:py-3 hover:bg-[#F0F2F5] dark:hover:bg-zinc-800 transition-colors border-b border-border/30 border-solid flex items-start justify-start shadow-none ${
