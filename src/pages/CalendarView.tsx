                ...
                <CardContent className="flex h-full flex-col justify-between p-5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="min-w-0 text-right">
                      <p className="font-calendarHeading text-xs font-semibold uppercase tracking-wider text-white/80">{item.label}</p>
                      <p className="font-calendarHeading text-4xl font-extrabold leading-none text-white">{item.value}</p>
                    </div>
                  </div>
                  <div className="mt-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {item.showPercent && <span className="w-9 text-right text-xs font-bold text-white">{item.progress}%</span>}
                    </div>
                  </div>
                </CardContent>
              </Card>
