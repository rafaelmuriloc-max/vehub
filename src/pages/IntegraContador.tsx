...
const SERVICE_CATALOG: Record<string, ServiceCategory> = {
  sn: {
    ...
    services: [
      ...
      { idSistema: 'PGDASD', idServico: 'CONSDECREC15', label: 'Declaração/Recibo por Nº', description: 'Consulta declaração e recibo por número da declaração', tipo: 'Consultar', fields: [F_NUM_DECLARACAO] },
      { idSistema: 'PGDASD', idServico: 'CONSEXTRATO16', label: 'Extrato do DAS', description: 'Consulta extrato do DAS pelo número do DAS', tipo: 'Consultar', fields: [F_NUM_DAS] },
      { idSistema: 'PGDASD', idServico: 'GERARDASCOBRANCA17', label: 'DAS Cobrança RFB', description: 'Gera DAS de cobrança da Receita Federal', tipo: 'Emitir', fields: [F_PERIODO] },
      ...
      { idSistema: 'DEFIS', idServico: 'CONSULTIMADECREC143', label: 'Última Declaração DEFIS', description: 'Consulta última declaração e recibo DEFIS', tipo: 'Consultar', fields: [] },
  ...
  caixapostal: {
    ...
    services: [
      ...
      { idSistema: 'DTE', idServico: 'CONSULTASITUACAODTE111', label: 'Situação Adesão DTE', description: 'Consulta situação de adesão à Caixa Postal eletrônica', tipo: 'Consultar', fields: [] },
    ],
  },
  situacaofiscal: {
  ...
  procuracoes: {
    ...
    services: [
      { idSistema: 'PROCURACOES', idServico: 'OBTERPROCURACAO41', label: 'Obter Procuração', description: 'Consulta procurações do contribuinte', tipo: 'Consultar', fields: [] },
    ],
  },
  gerenciador: {
    label: 'Gerenciador',
    ...
    services: [
      { idSistema: 'AUTENTICAPROCURADOR', idServico: 'ENVIOXMLASSINADO81', label: 'Token Procurador (XML)', description: 'Envio de XML assinado para obter TOKEN de procurador', tipo: 'Apoiar', fields: [] },
    ],
  },
  eventos: {
    ...
    services: [
      ...
      { idSistema: 'EVENTOSATUALIZACAO', idServico: 'SOLICEVENTOSPJ132', label: 'Solicitar Eventos PJ', description: 'Solicita eventos de atualização de Pessoa Jurídica', tipo: 'Monitorar', fields: [] },
      ...
      { idSistema: 'EVENTOSATUALIZACAO', idServico: 'OBTEREVENTOSPJ134', label: 'Obter Eventos PJ', description: 'Obtém eventos de atualização de Pessoa Jurídica', tipo: 'Monitorar', fields: [F_PROTOCOLO] },
    ],
  },
  parcelamentos: {
