...
export default function Personnel() {
  ...
  async function syncNow() {
    ...
    setSyncing(true);
    try {
      const total = { fichas_lidas: 0, funcionarios_encontrados: 0, funcionarios_criados: 0, funcionarios_atualizados: 0, revisao: 0, linhas_ignoradas: 0, linhas_sem_empresa: 0, empresas_atendidas: 0 };
      let restantes = 0;
